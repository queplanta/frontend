...
function ProfileChangeAvatar(props) {
  ...
  function handleSubmit(e) {
    ...
    ProfileChangeAvatarMutation.commit(
      environment,
      {},
      formData,
      {
        setFormErrors,
        onSuccess: () => {
          enqueueSnackbar('Imagem de exibição alterada com sucesso', {variant: "success"})
          setIsSaving(false)
        },
        onError: () => {
  ...
  return <React.Fragment>
    <Grid container spacing={3} component="form" onSubmit={handleSubmit}>
      ...
      <Grid item xs={12}>
        ...
        <Button size="small" variant="outlined" component="label" htmlFor="imagesInput">
          <AddPhotoAlternateIcon className={classes.buttonIcon} /> Alterar imagem de exibição
        </Button>
