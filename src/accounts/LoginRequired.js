...
export const LoginRequiredProvider = createFragmentContainer(function({relay, viewer, children}) {
  ...
  const contextValue = {isAuthenticated, toggleAuthDialog, openAuthDialog, closeAuthDialog};
  return <LoginRequiredContext.Provider value={contextValue}>
    {children}
...
export const withLoginRequired = (Component) => {
  ...
  WrappedComponent.displayName = `WithLoginRequired(${getDisplayName(Component)})`;
