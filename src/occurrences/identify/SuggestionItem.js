...
import {
  Card, CardHeader, Avatar, Grid, Chip,
...
function SuggestionItem(props) {
  ...
  return <ListItem className={clsx(classes.listItem, {[classes.correctItem]: isVerified})}>
    ...
    <ListItemText className={classes.root}>
     <Grid container spacing={0}>
        <Grid item xs={10}>
          <ProfileLink style={{fontWeight: 'bold'}} user={suggestion.author} hideAvatar={true} /> 
          <Typography style={{marginLeft: "6px"}} component="span" color="textSecondary">
            sugeriu: 
          </Typography>
          <Typography variant="caption" component="div" color="textSecondary">
            <RelativeDate prefix="Publicado" date={suggestion.revisionCreated.createdAt} />
          </Typography>
        </Grid>
        ...
        <Grid item xs={12} className={classes.gridContent}>
          ...
          {suggestion.notes && <Typography variant="body2">{suggestion.notes}</Typography>}
        </Grid>
