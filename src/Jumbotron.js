...
function Jumbotron({ classes, ...otherProps }) {
  return (
    <Container className={classes.jumbotron} {...otherProps}>
      ...
      <Grid container spacing={0} className={classes.listContainer}>
        <Grid
          item
          sm={6}
          component={(props) => <List component="div" {...props} />}
          disablePadding={true}
        >
          <ListItem
            component={Link}
          ...
          >
            <ListItemIcon component="span">
              <img
                src={cameraFlatIcon}
                alt=""
                className={classes.jumbotronListIcon}
              />
            </ListItemIcon>
            <ListItemText
              component="span"
              primary="Identifique plantas por fotos de forma colaborativa."
            />
          </ListItem>
          <ListItem component={Link} to="/mapa" className={classes.link}>
            <ListItemIcon component="span">
              <img
                src={locationFlatIcon}
                alt=""
                className={classes.jumbotronListIcon}
              />
            </ListItemIcon>
            <ListItemText
              component="span"
              primary="Encontre arvores em sua cidade."
            />
          </ListItem>
        </Grid>
        <Grid
        ...
        >
          <ListItem
            component={Link}
            to="/como-funciona/catalogo-pessoal"
            className={classes.link}
          >
            <ListItemIcon component="span">
              <img
                src={clipboardFlatIcon}
                alt=""
                className={classes.jumbotronListIcon}
              />
            </ListItemIcon>
          ...
          <ListItem component={Link} to="/feira" className={classes.link}>
            ...
            <ListItemText
              component="span"
              primary="Troque sementes com amigos."
            />
          </ListItem>
        </Grid>
      </Grid>
