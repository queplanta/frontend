...
import { Button, Grid, Dialog, DialogTitle, DialogContent, DialogActions, withStyles, useMediaQuery } from '@material-ui/core';
...
function CommonNameAdd(props) {
  ...
  function handleSubmit(e) {
    ...
    PlantAddCommonNameMutation.commit(
      ...
      },
      {
        setFormErrors,
        onSuccess: () => {
          enqueueSnackbar('Nome adicionado com sucesso', {variant: "success"})
          setIsSaving(false)
          setOpen(false)
        },
        onError: () => {
  ...
  return <React.Fragment>
    <Button variant="outlined" onClick={handleOpen}>Adicionar nome comum</Button>
    <Dialog
      keepMounted={false}
      open={isOpen}
      onClose={handleClose}
    ...
    >
      ...
      <DialogActions>
        ...
        <ButtonWithProgress type="submit" isLoading={isSaving} color="primary">
          Adicionar
        </ButtonWithProgress>
      </DialogActions>
    </Dialog>
