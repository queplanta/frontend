...
function PlantAdd(props) {
  ...
  function onSuccess(response) {
    ...
    router.push(`/${response.lifeNodeCreate.lifeNode.slug}-p${response.lifeNodeCreate.lifeNode.idInt}`)
  }
    ...
    <Grid container spacing={3}>
      <Grid item xs={12}>
        <form onSubmit={handleSubmit}>
          ...
          <ButtonWithProgress variant="outlined" className={classes.button} type="submit" isLoading={isSaving}>salvar</ButtonWithProgress>
        </form>
      </Grid>  
    </Grid>  
  </Width>
